...
import { updateTime, getTime } from '../../../actions/timeActions';
...
class MultipleSelect extends React.Component {
	...
	componentDidMount() {
		this.props.getTime(this.props.match.params.id);
	...
	componentWillReceiveProps(nextProps) {
		...
		if (nextProps.time.time) {
			const time = nextProps.time.time;
			this.setState({
...
export default connect(mapStateToProps, { updateTime, getTime })(
