...
import { getTopup, updateTopup} from "../../../actions/topupActions";
...
class MultipleSelect extends React.Component {
  ...
  componentDidMount() {
    ...
    this.props.getTopup(this.props.match.params.id)
  }
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.topup.topup) {
      const topup = nextProps.topup.topup;
  console.log(topup.course)

      this.setState({
        tax:               topup.tax,
        title:             topup.title,
        amount:            topup.amount,
        no_of_credits:       topup.no_of_credits,
...
onSubmit(e) 
{
 ...
 this.setState({total_credits:k})
  ...
  this.props.updateTopup(this.props.match.params.id,newBook,this.props.history);
  ...
  <div>
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb" style={nav}>
        ...
        <li class="breadcrumb-item active" aria-current="page">Edit TopUp</li>
      </ol>
    </nav>
    ...
    <div>
     <div className={classes.root}>
      <form   onSubmit={this.onSubmit} error>
        ...
        <InputLabel htmlFor="age-simple">Courses Name</InputLabel>
        <Select
...
MultipleSelect.propTypes = {
  ...
  updateTopup: PropTypes.func.isRequired,
...
export default  connect(mapStateToProps, { getCredits,getTopup,updateTopup,getCourselevels1 })(withStyles(styles, { withTheme: true })(MultipleSelect));
