...
import {getPackage,updatePackage } from "../../../actions/packageActions";
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.package.package) {
      ...
      this.setState({
        ...
        no_of_days:        packages.no_of_days,
        package_code:      packages.package_code,
        total_credits:     packages.total_credits,
        main_course_id:    packages.main_course_id,
        promocode_status:  packages.promocode_status,
        credits_per_month: packages.credits_per_month, 
      });
...
onSubmit(e) 
{
 ...
 this.setState({total_credits:k})
  ...
  this.props.updatePackage(this.props.match.params.id,newBook,this.props.history);
...
<li class="breadcrumb-item active" aria-current="page">Edit Package</li>
  ...
  <InputLabel htmlFor="age-simple">Course Name</InputLabel>
      <Select
...
{/* <FormControl className={classes.formControl}>
<InputLabel htmlFor="age-simple">PromoCode Status</InputLabel>
    <Select
...
export default connect(mapStateToProps, { getCredits,updatePackage,getPackage,getCourselevels1 })(withStyles(styles, { withTheme: true })(MultipleSelect));
