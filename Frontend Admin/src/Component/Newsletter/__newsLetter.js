...
class CustomPaginationActionsTable extends React.Component {
  ...
  <ol className="breadcrumb" style={nav}>
   ...
   Feedback List</li>
          ...
          <TableCell style={tablecolor}>Date & Time </TableCell>
              ...
              {rows.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map(row => {
                return (
                  <TableRow key={row.id}>
                    ...
                    <TableCell > 12:00PM-02:00PM, 10:00AM-12:00PM, 08:00AM-10:00AM, 02:00PM-04:00PM, 04:00PM-06:00PM, , 06:00PM-08:00PM, 08:00PM-10:00PM</TableCell>
